...
public class BallWorld implements BallEnvironment, Drawable, Temporal {
	...
	private List<Pulsar> pulsarBalls = new ArrayList<Pulsar>(); // used for
																// Gravity
																// objects
	private List<Bouncer> bouncerBalls = new ArrayList<Bouncer>(); // used for
																	// Gravity
																	// objects
	...
	public List<Pulsar> getPulsarBalls() {
		return this.pulsarBalls;
	}

	public List<Bouncer> getBouncerBalls() {
		return this.bouncerBalls;
	}
